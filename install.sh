...
# --- Wallpaper ---
if [ -f "$RICE_DIR/wallpapers/wallpaper.jpg" ]; then
  echo "→ Installing wallpaper..."
  cp "$RICE_DIR/wallpapers/wallpaper.jpg" "$CONFIG/hypr/wallpaper.jpg"
elif [ -f "$RICE_DIR/wallpapers/wallpaper.png" ]; then
  echo "→ Installing wallpaper (PNG)..."
  cp "$RICE_DIR/wallpapers/wallpaper.png" "$CONFIG/hypr/wallpaper.png"
  # Update hyprpaper.conf to use .png
  sed -i 's/wallpaper\.jpg/wallpaper.png/g' "$CONFIG/hypr/hyprpaper.conf"
else
  echo "⚠️  No wallpaper found in wallpapers/ — set one manually at ~/.config/hypr/wallpaper.jpg"
fi
